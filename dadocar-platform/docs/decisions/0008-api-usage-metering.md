...
2. **`api_products`** — the sellable consult types per API (`api`, `code`, `name`, `unit_price_brl`). Seeded with the CheckTudo products at the Placas360 storefront prices (66 Veículo Total R$44,90; 67 Essencial R$29,90; 13 Decod+Precificador R$19,90; 71 Cadastrais R$9,90; 76 Decod+FIPE R$17,90; 241 Decod V.4 R$12,90; 65 Total Plus R$60,00).
